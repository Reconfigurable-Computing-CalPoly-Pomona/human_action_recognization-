...
class TfPoseEstimator:
    ...
    def __init__(self, graph_path, target_size=(320, 240), tf_config=None):
        ...
        self.tensor_image = self.graph.get_tensor_by_name('TfPoseEstimator/image:0')#input_1:0')
        self.tensor_output = self.graph.get_tensor_by_name('TfPoseEstimator/Openpose/concat_stage7:0')#dense_2/Softmax:0')
