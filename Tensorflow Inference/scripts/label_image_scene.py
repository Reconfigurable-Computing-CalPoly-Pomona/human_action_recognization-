...
# =============================================================================
  ...
  #path = os.path.join(file_path, '../models/graph/LSTM/')
  #model_file = path+'lstm-features.011-0.808.pb'
  path = os.path.join(file_path, '../models/graph/Inception/')
  model_file = path+'inception.022-1.30.pb'
