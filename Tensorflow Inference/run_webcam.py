...
if __name__ == '__main__':
    ...
    parser.add_argument('--model', type=str, default='mobilenet_thin', help='cmu / mobilenet_thin / Inception')
    ...
    #else:
    #    e = TfPoseEstimator(get_graph_path(args.model), target_size=(1920, 1080))
    ...
    while True:
        ...
        cv2.putText(image, "FPS: %f" % (1.0 / (time.time() - fps_time)), (20, 60),
                    cv2.FONT_HERSHEY_SIMPLEX, 0.6,
                    (0, 0, 255), 1)        
        
        cv2.putText(image, "Predicted Scene: %s" %(scene_class), 
