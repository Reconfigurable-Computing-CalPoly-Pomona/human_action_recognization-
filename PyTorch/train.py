...
def train_model(dataset=dataset, save_dir=save_dir, num_classes=num_classes, lr=lr,
    ...
    train_dataloader = DataLoader(VideoDataset(dataset=dataset, split='train',clip_len=16), batch_size=8, shuffle=True, num_workers=4)
    ...
    for epoch in range(resume_epoch, num_epochs):
        ...
        for phase in ['train', 'val']:
            ...
            for inputs, labels in tqdm(trainval_loaders[phase]):
                ...
                labels = Variable(labels).to(device=device,dtype=torch.long)
                optimizer.zero_grad()
